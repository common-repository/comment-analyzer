 ...
 * Author: shaileshtyagi,aftab.alam8028
 * Version: 1.0.0
 */
class comment_analysis {
    ...
    function save_sentiment_response($comment_ID) {
        ...
        if (!class_exists('SentimentAnalysis')) {
            include_once( dirname(__FILE__) . '/php-sentiment-analyser/lib/sentiment_analyser.class.php' );
        }
